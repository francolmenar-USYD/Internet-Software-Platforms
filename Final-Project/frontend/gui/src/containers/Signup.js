...
class Signup extends React.Component {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        try {
            ...
            axios.post('http://ec2-13-55-117-84.ap-southeast-2.compute.amazonaws.com:8000/user/api/add_user/', values).
            then(res => {
              if (res.status == 200) {
  ...
  render() {
    ...
    return (
      <Form style={{marginTop:"10vh"}} onSubmit= {this.handleSubmit}>
        {/* Title */}
        <Form.Item wrapperCol={{span: 6, offset:9}} ><h1>Sign Up With Bird</h1></Form.Item>
